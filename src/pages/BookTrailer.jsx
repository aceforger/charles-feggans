...
const BookTrailer = () => {
  ...
  return (
    <section id="trailer" className="py-20 bg-gradient-to-b from-gray-100 to-gray-200">
      ...
      <div className="relative">
        ...
        >
          {/* Light pink background for the book */}
          ...
          {/* <div className="absolute top-4 right-4 z-20">
            <div className="bg-orange-500 text-white px-4 py-2 rounded-full text-sm font-bold shadow-lg transform transition-transform duration-500 group-hover:scale-110">
              🎬 Coming Soon
            </div>
          </div> */}
      ...
      <div className="mt-6 text-center">
        <h3 className="text-2xl font-serif text-gray-800 mb-2">Trapped by Impulsion</h3>
  ...
  <div className="relative">
    <div 
      ...
      onClick={() => alert('Video trailer coming soon!')}
    >
      {/* Light yellow background for the book */}
      <div className="absolute inset-0 bg-yellow-100"></div>
      
      <img 
        src="/images/image4.png" 
        alt="Unpleasant Pastures Book Cover" 
        className="w-full h-[50vh] object-contain p-4 transition-transform duration-700 group-hover:scale-105 relative z-10"
      />
  ...
  <div className="mt-6 text-center">
    <h3 className="text-2xl font-serif text-gray-800 mb-2">Unpleasant Pastures</h3>
    <p className="text-gray-600 mb-4">Now available</p>
    {/* <button 
      onClick={() => alert('Video trailer coming soon!')}
      className="inline-flex items-center px-5 py-2 bg-gradient-to-r from-orange-500 to-orange-400 text-white rounded-full font-medium hover:shadow-lg transition-all duration-300 opacity-75 cursor-not-allowed"
    ...
    >
      ...
      Coming Soon
        ...
        {/* Miller Homes Truth and Fictional*/}
        <div className="bg-white rounded-xl shadow-lg p-6 transition-all duration-500 hover:shadow-xl hover:-translate-y-2">
  <div className="relative">
    <div 
      className="relative rounded-xl overflow-hidden shadow-md cursor-not-allowed group"
      onClick={() => alert('Video trailer coming soon!')}
    >
      {/* Light green background for the book */}
      <div className="absolute inset-0 bg-green-100"></div>
      
      <img 
        src="/images/image2.png" 
        alt="Miller Homes Truth and Fictional Book Cover" 
        className="w-full h-[50vh] object-contain p-4 transition-transform duration-700 group-hover:scale-105 relative z-10"
      />
  ...
  <div className="mt-6 text-center">
    <h3 className="text-2xl font-serif text-gray-800 mb-2">Miller Homes Truth and Fictional</h3>
    <p className="text-gray-600 mb-4">Now available</p>
    {/* <button 
      onClick={() => alert('Video trailer coming soon!')}
      className="inline-flex items-center px-5 py-2 bg-gradient-to-r from-orange-500 to-orange-400 text-white rounded-full font-medium hover:shadow-lg transition-all duration-300 opacity-75 cursor-not-allowed"
    ...
    >
      ...
      Coming Soon
         ...
         {/* Miller Homes II Five Years Later */}
         <div className="bg-white rounded-xl shadow-lg p-6 transition-all duration-500 hover:shadow-xl hover:-translate-y-2">
  <div className="relative">
    <div 
      className="relative rounded-xl overflow-hidden shadow-md cursor-not-allowed group"
    ...
    >
      ...
      <img 
        ...
        alt="Miller Homes II Five Years Later Book Cover" 
        className="w-full h-[50vh] object-contain p-4 transition-transform duration-700 group-hover:scale-105 relative z-10"
      />
  ...
  <div className="mt-6 text-center">
    <h3 className="text-2xl font-serif text-gray-800 mb-2">Miller Homes II Five Years Later</h3>
    <p className="text-gray-600 mb-4">Now available</p>
    {/* <button 
      onClick={() => alert('Video trailer coming soon!')}
      className="inline-flex items-center px-5 py-2 bg-gradient-to-r from-orange-500 to-orange-400 text-white rounded-full font-medium hover:shadow-lg transition-all duration-300 opacity-75 cursor-not-allowed"
