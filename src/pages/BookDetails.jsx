...
const mockBooks = [
  { 
    ...
    description: 'Jack Wilson was an exceptional type of guy you would meet on the street. Always willing to lend a helping hand to anyone in need.  And carried a pleasant smile. One day he found himself without a job due to a previous layoff in a factory that went out of business. Needing work to help support a family, he took a job working inside a prison where he made daily direct contact with inmates. Being the type of person he was, it was not long before he started answering their small request for outside items.', 
    postDate: 'May 21, 2025',
    quote: '"Even when life closed doors on him, Jack Wilson never closed his heart." - Cultural Reviews',
    relatedTopics: [
      { title: 'CHARLES FEGGANS', link: 'More Information >' },
    ]
  },
  { 
    id: '2', 
    ...
    description: 'A young marine experiences the horrors of war at a non-combat camp in Vietnam.', 
    postDate: 'August 18, 2021',
    quote: '“In a place meant to be safe, he discovered that the true horrors of war have no boundaries.”',
    relatedTopics: [
      { title: 'CHARLES FEGGANS', link: 'More Information >' },
    ]
  }, 
  { 
    ...
    description: 'Miller Homes is a community housing development known for warehousing low-income people. There, trouble always seems to be brewing. Gangs fight over this territory while residents are calling on city officials to take action to bring peace to the community.', 
    postDate: 'May 21, 2025',
    quote: '“In Miller Homes, survival isn’t a choice — it’s a daily battle between hope, hustle, and hard reality.”',
    relatedTopics: [
      { title: 'CHARLES FEGGANS', link: 'More Information >' },
    ]
  }, 
  { 
    id: '4', 
    title: 'MILLER HOMES II FIVE YEARS LATER', 
    author: 'CHARLES FEGGANS', 
    image: '/images/image3.png', 
    description: 'Among the residents of Miller Homes is Bertha, a woman in her early thirties who has been forced to live in the development due to her inability to find a job that pays well enough to allow her to move up in the world. She is also an activist for the community, crusading to make Miller Homes a better and safer place to live',
    quote: '“Trapped by circumstance but driven by courage, Bertha fights not just for herself — but for a safer future for everyone in Miller Homes.”',
    relatedTopics: [
      { title: 'CHARLES FEGGANS', link: 'More Information >' },
    ]
  }
